...
// MAIN ACTION FILE FOR THE HOME PAGE
const Actions = ({ post }) => {
...
//       {/* Onclick open model to post a comment */}
//       <Modal isOpen={isOpen} onClose={onClose}>
// 				<ModalOverlay />
// 				<ModalContent>
// 					<ModalHeader></ModalHeader>
...
// 							/>
// 						</FormControl>
// 						<Button mt={1} colorScheme='blue' size={"sm"} mr={3} isLoading={isReplying} onClick={handleReply}>
// 						<FiSend size={25} />
// 						</Button>
// 						</Flex>
// 					</ModalBody>
